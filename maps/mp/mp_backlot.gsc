...
main()
{
	...
	thread sr\api\_map::create_spawn((-650, 1939, 124), 314);
	thread sr\api\_map::create_normal_way("Normal Way;Glitch Way;");
	thread sr\api\_map::create_endmap((-549, -2428, 126), 120, 100);
	thread sr\api\_map::create_endmap((143, -1418, 364), 120, 100, "ns1");
}
