...
main()
{
	...
	if(auto_spawn.size > 0)
		thread speedrun\_way_name::create_spawn_auto(auto_spawn[int(auto_spawn.size / 2)].origin - (0,0,30), auto_spawn[int(auto_spawn.size / 2)].angles[1]);
	maps\mp\_load::main();
	// thread ambient();

	thread speedrun\_way_name::create_endmap((2336, -1354, -196), 200, 150);

	thread speedrun\_way_name::create_tp((3856, -1057, -145), 100, 150, 
	...
	/* [AUTO DELETE] thread KnifeFight(); */
	/* [AUTO DELETE] thread OldFight(); */
	/* [AUTO DELETE] //bounce room respawn
	thread bouncerspawn1(); */
	/* [AUTO DELETE] thread bouncerspawn2(); */
...
endMusic()
{
	AmbientStop(1);
	wait 0.5;
	/* [AUTO DELETE] AmbientPlay("sniper"); */
	wait (5);
...
endMusic1()
{
	AmbientStop(1);
	wait 0.5;
	/* [AUTO DELETE] AmbientPlay("bounce"); */
	wait (5);
...
endMusic3()
{
	AmbientStop(1);
	wait 0.5;
	/* [AUTO DELETE] AmbientPlay("old"); */
	/* [AUTO DELETE] iprintln("^1>>^4Now Playing: ^2JamerikanBeatz^1<<"); */
	/* [AUTO DELETE] iprintln("^1>>^4Now Playing: ^2JamerikanBeatz^1<<"); */
}
