...
thread speedrun\_way_name::create_spawn((-731,534,-76),360);
thread speedrun\_way_name::create_normal_way("Normal Way;");
thread speedrun\_way_name::create_secret_way("Secret Way;");
thread speedrun\_way_name::create_tp((962.114, 512.29, -58.875), 55, 10, (-682, -168, -612), 1, "freeze", "blue", "ns0");
thread speedrun\_way_name::create_tp((952.644, -170.768, -671.875), 65, 10, (1033, -156, -356), 360, "freeze", "blue", "ns0");
thread speedrun\_way_name::create_tp((1970.48, -160.444, -415.875), 55, 10, (4576, -167, -282), 1, "freeze", "blue", "ns0");
thread speedrun\_way_name::create_tp((6090.38, -163.3, -369.875), 55, 10, (6185, -174, -309), 1, "freeze", "blue", "ns0");
thread speedrun\_way_name::create_tp((-284.331, 755.019, 16.125), 60, 10, (15383, 1091, 2496), 270, "freeze", "red", "s0");
thread speedrun\_way_name::create_endmap((11840, -169.779, -463.875), 100, 10, "ns0");
thread speedrun\_way_name::create_endmap((15369.4, -725.747, 2821.13), 85, 10, "s1");
thread autofunc();	
thread autoplatform();
