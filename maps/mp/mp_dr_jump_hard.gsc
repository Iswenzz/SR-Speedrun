...
//setExpFog(300, 3500, .5, 0.5, 0.45, 0);
        ...
        thread sr\api\_map::create_secret_way("Easy Secret;Hard Secret;");

        thread sr\api\_map::create_spawn((-727,309,60),269);

        thread sr\api\_map::create_tp((-1007, 299, 60), 90, 15, (-479, -1478, -5828), 90, "freeze", "blue", "s0");
        thread sr\api\_map::create_tp((-502, 288, 60), 80, 15, (-9502, 4849, -5924), 0, "freeze", "red", "s1");

        thread sr\api\_map::create_endmap((2655.22, 1895.58, -7503.88), 180, 80, "s0");
        thread sr\api\_map::create_endmap((-10431.3, -1686.65, -9007.88), 170, 80, "s1");
