main()
{
	...
	thread sr\api\_map::create_normal_way("^2Easy Way;^2Easy+ Way;^3Inter Way;^3Inter+ Way;^1Hard Way;");
	thread sr\api\_map::create_secret_way("^2Easy Secret;^2Easy+ Secret;^3Inter Secret;^3Inter+ Secret;^1Hard Secret;");
...
secret_hard()
{
	...
	{
	trig waittill("trigger", player);
	player thread sr\api\_map::finish_way("s4");
...
secret_ii()
{
	...
	{
	trig waittill("trigger", player);
	player thread sr\api\_map::finish_way("s3");
		// iPrintlnBold("^4" + player.name + " ^7Has finished inter + secret");
...
secret_hard2()
{
	...
	{
	trig waittill("trigger", player);
	player thread sr\api\_map::change_way("s4");
...
secret_ezz2()
{
	...
	{
	trig waittill("trigger", player);
	player thread sr\api\_map::change_way("s1");
		// player iPrintlnBold("You entered easy + secret");
		// wait 1;
}
}
secret_i2()
{
	...
	{
	trig waittill("trigger", player);
	player thread sr\api\_map::change_way("s2");
...
secret_ii2()
{
	...
	{
	trig waittill("trigger", player);
	player thread sr\api\_map::change_way("s3");
		// player iPrintlnBold("You entered inter + secret");
		// wait 1;
}
}