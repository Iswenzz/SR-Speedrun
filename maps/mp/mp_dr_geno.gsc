main()
{
thread sr\api\_map::createSpawnOrigin((-232, -15, 16), 360);
maps\mp\_load::main();
...
thread sr\api\_speedrun::createEndMap((22833.9, 300.328, -8606.88), 245, 10, "normal_0");
thread sr\api\_speedrun::createTeleporter((6.28732, -605.196, 16.125), 275, 20, (1506, -553, 76), 270, "freeze", "cyan", "normal_1");
thread sr\api\_speedrun::createTeleporter((24.2553, 67.478, 16.125), 55, 10, (7951, -18949, -7410), 180, "freeze", "yellow", "secret_0");
...
eztptofinish()
{
   trig = getent("trig_lastroom_easy", "targetname");
