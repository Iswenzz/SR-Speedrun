...
main()
{
	...
	thread sr\api\_speedrun::createTeleporter((-676, 0, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
	thread sr\api\_speedrun::createTeleporter((-676, 300, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
	thread sr\api\_speedrun::createTeleporter((-676, 600, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
	thread sr\api\_speedrun::createTeleporter((-676, 900, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");

	thread sr\api\_speedrun::createTeleporter((738, 0, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
	thread sr\api\_speedrun::createTeleporter((738, 300, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
	thread sr\api\_speedrun::createTeleporter((738, 600, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
	thread sr\api\_speedrun::createTeleporter((738, 900, 370), 300, 600, (66, -1020, 651), 90, "freeze", "cyan");
