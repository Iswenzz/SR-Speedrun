...
main()
 {
thread sr\api\_map::createSpawnOrigin((-369.875, 50, 16.125), 0);
	maps\mp\_load::main();
	//////////////////// Precache
...
sr_tp()
{
	ori = spawn("script_origin",(-5566,-246,-1984));
	ori.angles = (0,270,0);
...
trap3() {
	...
	level.trap3_laser0 delete();
	level.trap3_laser1 delete();
	level.trap3_laser2 delete();
	level.trap3_laser3 delete();
	red delete();
	blue delete();
