...
trigger.radius = 315;
        ...
        thread sr\api\_map::createSpawn((-881,513,604),360);
	thread sr\api\_speedrun::createNormalWays("Normal Way;");
        thread sr\api\_speedrun::createSecretWays("Secret Way;");
        thread sr\api\_speedrun::createTeleporter((-812.956, 795.077, 544.125), 95, 90, (-952, 2810, 828), 360, "freeze", "cyan", "secret_0");
