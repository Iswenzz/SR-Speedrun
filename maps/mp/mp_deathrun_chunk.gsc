...
//-----------------Threads-----------------//
	...
	thread sr\api\_speedrun::createTeleporter((-1538.08, 129.394, 24.125), 50, 50, (-2638, -191, 1163), 90, "freeze", "yellow", "secret_0");
    thread sr\api\_speedrun::createTeleporter((-444.89, 1822.65, 664.125), 120, 30, (67, 1927, 725), 268, "freeze");
	//thread nospawnshoot();
	thread startdoor();
	//thread trap1();
	//thread trap2();
...
travel1 rotateyaw(90, 0.1);
wait 0.1;
travel1 movey(-180, 0.1);
wait 0.3;
travel1 moveX(20, 0.1);
