main()
{
thread sr\api\_map::createSpawnOrigin((825, 368, 200), 270);
...
secret_1()
{
	...
	trigger = spawn( "trigger_radius", (602.763, 288.455, 192.625), 0, 70, 90 );
...
derpy()
{
	...
	while(1)
	{
		...
		// player sr\api\_player::setPlayerGravity(5);
		// level.activ sr\api\_player::setPlayerGravity(5);
...
gravity()
{
	...
	while(1)
	{
		...
		// player sr\api\_player::setPlayerGravity(300);
		// level.activ sr\api\_player::setPlayerGravity(300);
...
games()
{
		...
		// player sr\api\_player::setPlayerGravity(800);
		// level.activ sr\api\_player::setPlayerGravity(800);
