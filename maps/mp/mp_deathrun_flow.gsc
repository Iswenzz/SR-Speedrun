main()
{
	...
	thread sr\api\_speedrun::createTeleporter((-1313.44, 990.343, 16.125), 105, 80, "orange", "normal_1");
	thread sr\api\_speedrun::createTeleporter((-799.691, 997.213, 16.125), 100, 80, "blue", "normal_2");
	thread sr\api\_speedrun::createTeleporter((-285.09, 999.401, 16.125), 100, 80, "red", "normal_3");
	thread sr\api\_speedrun::createTeleporter((225.086, 1001.78, 16.125), 100, 80, "cyan", "normal_4");
