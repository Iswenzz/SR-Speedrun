...
thread sr\api\_map::create_spawn((-11760, 2603, 78), 270);

thread sr\api\_map::create_tp((-11539, 2404, 76), 100, 150, 
	eztp.origin, eztp.angles[1], "freeze", "green", "s0");
thread sr\api\_map::create_tp((-11986, 2404, 76), 100, 150, 
...
/* [AUTO DELETE] iPrintLnBold("^4HARD MODE ACTIVATED!!!"); */
	{
	lazer1 show();
	lazer1 solid();
...
startc = getEnt("startdoor_c","targetname");
	...
	startb delete();
	wait 0.1;
	/* [AUTO DELETE] iprintlnbold("^8Start door opened :]"); */
	wait 1;
...
secret1trig = getEnt("secretsenter1","targetname");
	...
	/* [AUTO DELETE] iprintlnbold("^5Secret ^7Opened"); */
	showsecret show();
	showsecret solid();
