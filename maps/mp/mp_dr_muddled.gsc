...
main()
{
thread sr\api\_map::createSpawnOrigin((-223.875, 32, -95.875), 0);
...
tp_1()
{
	trigger = spawn( "trigger_radius", (-7170.61, 0.137155, -175.875), 0, 120, 90 );
	ori = spawn( "script_origin", (-7465, 0, 408));
