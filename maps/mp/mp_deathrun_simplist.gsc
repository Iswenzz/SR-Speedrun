...
main()
{
	thread sr\api\_map::create_normal_way("^4Easy Way;^2Hard Way");
	thread sr\api\_map::create_tp((-53, -208, 76), 100, 150, (-969, -598, 16), 270, "freeze", "blue", "ns0");
	thread sr\api\_map::create_tp((283, -208, 76), 100, 150, (1211, -595, 16), 270, "freeze", "green", "ns1");
	thread sr\api\_map::create_spawn((120, 108, 76), 270);
	thread sr\api\_map::create_endmap((137, -8308, 76), 100, 150);
	thread sr\api\_map::create_endmap((-957, -8273, 76), 100, 150, "ns0");
	thread sr\api\_map::create_endmap((1283, -8353, -68), 100, 150, "ns1");
 ...
 start()
 {
	 ...
	 /* [AUTO DELETE] iPrintLnBold (" ^2Map by ^6Sheep Wizard"); */
	 /* [AUTO DELETE] iPrintLn ("^2Map by ^6Sheep Wizard"); */
	 // wait 1;
	 ...
	 /* [AUTO DELETE] ambientPlay("music1"); *///disbale this is you want
...
end()//end room add more weapons if you wish
{
     ...
     else if(x == 2)
	 {
	     ...
	     /* [AUTO DELETE] level.activ TakeAllWeapons(); */
	     /* [AUTO DELETE] level.activ giveWeapon ("dragunov_acog_mp" ); */
		}
     else if(x == 3)
	 {
     ...
     else if(x == 4)
	 {
	     ...
	     /* [AUTO DELETE] level.activ TakeAllWeapons(); */
	     /* [AUTO DELETE] level.activ giveWeapon ("barrett_mp" ); */
		}
     else if(x == 5)
	 {
     ...
     else if(x == 7)
	 {
	     ...
	     /* [AUTO DELETE] level.activ TakeAllWeapons(); */
	     /* [AUTO DELETE] level.activ giveWeapon ("dragunov_mp" ); */
		}
	 else if(x == 8)
	 {
