...
main()
{
thread sr\api\_map::createSpawnOrigin((-722, 529, 16), 359);
	maps\mp\_load::main();
	...
	for(;;)
{
	...
	if( isSubStr( toLower(username), toLower("brahmi") ) || username == "CAR DarkSTEP" || username == "Sr Brahmi" || username == "pizzaman")
{
	player.fuu = true;
