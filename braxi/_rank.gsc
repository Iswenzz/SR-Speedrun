...
isCharacterUnlocked( num )
{
	...
	if( self.pers["rank"] >= level.characterInfo[num]["rank"]
		&& self.pers["prestige"] >= level.characterInfo[num]["prestige"] )
		return true;
	return false;
}
...
isItemUnlocked( num )
{
	...
	if( self.pers["rank"] >= level.itemInfo[num]["rank"]
		&& self.pers["prestige"] >= level.itemInfo[num]["prestige"] )
		return true;
	return false;
}
...
isSprayUnlocked( num )
{
	...
	if( self.pers["rank"] >= level.sprayInfo[num]["rank"]
		&& self.pers["prestige"] >= level.sprayInfo[num]["prestige"] )
		return true;
	return false;
}
...
isKnifeUnlocked( num )
{
	...
	if( self.pers["rank"] >= level.knifeInfo[num]["rank"]
		&& self.pers["prestige"] >= level.knifeInfo[num]["prestige"] )
		return true;
	return false;
}
...
isGloveUnlocked( num )
{
	...
	if (self.pers["prestige"] > level.gloveInfo[num]["prestige"])
		return true;
	if( self.pers["rank"] >= level.gloveInfo[num]["rank"]
		&& self.pers["prestige"] >= level.gloveInfo[num]["prestige"] )
		return true;
	return false;
}
...
isFxUnlocked( num )
{
	...
	if (self.pers["prestige"] > level.fxInfo[num]["prestige"])
		return true;
	if( self.pers["rank"] >= level.fxInfo[num]["rank"]
		&& self.pers["prestige"] >= level.fxInfo[num]["prestige"] )
		return true;
	return false;
}
